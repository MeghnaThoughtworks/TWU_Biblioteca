...
public class BibliotecaApp {
    ...
    private static final Option optionTwo = new CheckoutItem<>(catalogBook, inputReader);
    ...
    private static final Option optionSix = new CheckoutItem<>(catalogMovie, inputReader);
